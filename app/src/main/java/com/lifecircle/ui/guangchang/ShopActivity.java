...
import com.lifecircle.view.shopcar.PinnedHeaderListView;
import com.lifecircle.view.shopcar.TestSectionedAdapter;
...
public class ShopActivity extends BaseActivity implements View.OnClickListener{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		//头部
		initHead();
		final PinnedHeaderListView right_listview =  findViewById(R.id.pinnedListView);
	...
	public class MyAdapter extends BaseAdapter {
		...
		public View getView(int arg0, View arg1, ViewGroup arg2) {
			...
			if (arg1 == null) {
				holder = new Holder();
				arg1 = LayoutInflater.from(ShopActivity.this).inflate(R.layout.left_list_item, null);
